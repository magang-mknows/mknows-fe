...
export const InfoSection: FC = (): ReactElement => {
  return (
    <div className="mt-[61px] grid grid-cols-4 gap-[24px]">
      <Card
        className="bg-[#FFFFFF] shadow-[0_3px_23px_10px_rgb(150,150,150,0.1)] px-[20px] py-[28px] rounded"
        hasImage={false}
        children={
          <div className="flex">
            <Image src={Pendaftar} alt="tes" />
            <div className="px-[16px]">
              <p className="text-[24px] font-bold text-[#171717]">2500</p>
              <p>pendaftar</p>
            </div>
          </div>
        }
      ...
      <Card
        ...
        children={
          <div className="flex">
            ...
            <div className="px-[16px]">
              <p className="text-[24px] font-bold text-[#171717]">1000</p>
              <p>pendaftar</p>
            </div>
          </div>
        }
