        ...
        <div className="flex flex-wrap mb-20 lg:justify-start md:justify-around justify-center md:gap-10 lg:gap-20 gap-5">
          {getSubmission?.map((items: TSimulationItem, i: any) => (
            <Card
              ...
              hasImage
              src={drillDummy}
              className="px-0 py-0  border-neutral-200 border  rounded-lg cursor-default"
            ...
            >
              <div className="mb-10 px-5 w-full relative">
                ...
                <div className="flex font-[500] text-[12px] text-neutral-700 rounded-[7px] gap-4 mt-5">
                ...
                <div className="text-[16px] font-[600] text-neutral-800 mt-3 ml-1 dark:text-white">
                  {items.topic}
                </div>
                <div className="flex mt-4 justify-end">
                  ...
                  >
                    <Button
                      ...
                      type="submit"
                      className="bg-success-500  font-[600] text-[12px] rounded-[8px] text-white w-[182px] h-[35px]  disabled:bg-neutral-300 disabled:text-neutral-base  disabled:cursor-not-allowed"
                    >
                      <h1>
                        {items.schedules.length === 0
