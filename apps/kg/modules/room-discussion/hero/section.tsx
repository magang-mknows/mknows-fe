...
const DiscussionHero: FC = (): ReactElement => {
  return (
    <section className="grid grid-cols-1 gap-10 px-8 md:px-14 lg:px-16 md:grid-cols-2 md:gap-20">
      <div className="relative z-10 flex flex-col items-center justify-center order-2 w-full h-full md:order-1 ">
