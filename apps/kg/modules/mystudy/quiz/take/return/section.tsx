      ...
      <div className="flex flex-col md:flex-row min-h-[550px] items-center gap-11 text-[#171717]">
        ...
        <div className="flex flex-col gap-y-[39px] h-[475px]">
          ...
          <button
            ...
            className="w-full h-[42px] lg:w-[328px] lg:h-[56px] text-[16px] font-medium bg-[#106FA4] text-white  flex gap-x-2 rounded justify-center items-center hover:opacity-75 duration-200"
          >
            Lanjutkan Quiz
          </button>
        </div>
