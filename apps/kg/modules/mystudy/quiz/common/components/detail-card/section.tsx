...
export const DetailCard: FC<DetailCardProps> = ({ type, value, link = "" }): ReactElement => {
  return (
    <Link
      type="button"
      href={link}
    ...
    >
      {type === "trueAnswer" && <BsCheckCircleFill className="text-[#3EB449] mt-1 text-4xl" />}
      {type === "falseAnswer" && <FaTimesCircle className="text-[#ED3768] mt-1 text-4xl" />}
