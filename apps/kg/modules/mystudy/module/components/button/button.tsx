...
export const ModuleButton: FC<ButtonProps> = ({
  className,
  textStyle,
  type,
  onClick,
  ...
  const merged = `flex gap-x-2 rounded justify-center items-center hover:opacity-50 ${colorClass[color]} ${sizesClass[size]} ${className}`;
