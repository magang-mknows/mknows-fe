...
export const AnalysisResult: FC = (): ReactElement => {
  ...
  return (
    <section className="lg:px-16 md:px-10 px-5 py-3 w-full mt-[36px] drop-shadow-md min-h-screen bg-[#FAFAFA] pb-10">
      <div className="flex md:flex-row flex-col lg:gap-16 md:gap-8 gap-10">
        ...
        <div className=" md:basis-2/3">
          <section className="card-ringkasan text-[#262626]">
          ...
          <section className="card-tools">
            <h1 className="text-[24px] font-[600] text-[#000000] mb-4 mt-8">
            ...
            <div className="flex md:flex-row flex-col lg:flex-nowrap md:flex-wrap gap-10 ">
              {dataTool.map((tool, i) => (
                <div className="w-full bg-white px-10 py-10 shadow-md" key={i}>
                  ...
                  <h3 className="text-[#34364A] text-[18px] font-[600] mt-4">{tool.name}</h3>
                  <p className="text-[#999AA4] text-[16px] font-[300]">{tool.category}</p>
                </div>
              ))}
            </div>
          </section>
