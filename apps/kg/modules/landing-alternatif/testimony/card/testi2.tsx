...
export const TestimonyCard2: FC = (): ReactElement => {
  return (
    <div className="flex flex-col bg-white w-[406px] h-[254px] rounded-md shadow-md p-6">
      <div className="flex gap-3">
        ...
        <span className="flex flex-col justify-center items-center">
          <p className="text-[18px] font-semibold font-700">Meilani</p>
          <p className="text-neutral-400 text-[16px]">Front End Dev</p>
        </span>
      </div>
      <div>
        <p className="text-neutral-400 text-[16px] pt-[24px]">
