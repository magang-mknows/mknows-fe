...
const TaskCarouselSection: FC = (): ReactElement => {
  ...
  return (
    <div className="bg-white dark:bg-[#1B1E21] p-7 rounded-md shadow-sm w-full overflow-hidden">
          ...
          return (
            ...
            <div key={index} className="">
              <section className="text-neutral-900 mb-4 flex flex-col w-full">
                <h1 className="text-lg font-bold dark:text-white w-fit">
                  Penugasan
                </h1>
              ...
              <section className="flex flex-col md:flex-row justify-between gap-4 items-center">
                <button className="text-white w-[95%] lg:w-44 mx-auto md:mx-0  mb-2  bg-primary-500 dark:bg-[#17A2B8] dark:hover:bg-[#138697] text-xs lg:text-sm py-3 px-4 rounded-md hover:bg-primary-600 transition-colors ease-in-out duration-300">
                  Kerjakan Sekarang
                </button>
...
export default TaskCarouselSection;
