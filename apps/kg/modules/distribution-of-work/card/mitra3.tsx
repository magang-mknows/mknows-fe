  ...
  return (
    <div className="flex flex-col bg-white w-[280px] h-[350px] rounded-md my-6 shadow-xl px-4">
      <div className="flex w-full justify-center">
        <Image src={goggle} alt="logo" />
      </div>
      <h1 className="text-primary-500 font-bold">Data Analysis</h1>
      <p className="text-primary-500 py-4">PT Goggle Indonesia</p>
      <p className="text-neutral-500 ">Kota Tangerang Jawa Barat</p>
      <p className="text-neutral-500">Rp 2.000.000 - 6.000.000</p>
      <p className="text-neutral-500">Part Time</p>
