...
export const HoverCard: FC = (): ReactElement => {
  return (
    <section className="flex flex-col bg-white rounded-lg shadow-sm w-[313.7px] h-[131.09px] z-10 absolute lg:left-20 2xl:left-[200px] bottom-16 py-[30px] pl-[30px] pr-[24.7px] gap-y-3 justify-between">
