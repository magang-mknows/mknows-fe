...
export const CARD: Array<TArticleCardProps> = [
  {
    title:
      '5 Extension VSCode yang bakal ngebantu kamu pas ngoding. Nomer 2 sering dipake!',
    tag: 'Programmer',
  ...
  {
    title:
      '4 Tips yang mungkin belum kamu tau saat menanam sayur agar tidak mudah diserang hama',
  ...
  {
    title:
      'Perusahaanmu ada 5 poin penting ini dalam masalah keuangan mereka? ',
