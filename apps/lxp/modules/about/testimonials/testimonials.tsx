          ...
          {dummyTestimonials.map((testimoni, index) => {
            return (
              <section className="py-14" key={index}>
                <div
                  className={`${
                    (index + 1) % 2 !== 0 ? "bg-version2-400" : " bg-version2-500"
                ...
                >
                  ...
                  <section className="-mt-14 text-center mb-8">
                    <h1 className="text-neutral-100 font-medium text-base">{testimoni.name}</h1>
                    <p className="text-neutral-200/90 text-sm">{testimoni.position}</p>
                  </section>
