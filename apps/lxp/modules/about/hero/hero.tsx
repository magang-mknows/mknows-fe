    ...
    <div className="px-8 md:px-14 relative lg:px-16 bg-center bg-cover  min-h-[80vh] grid grid-cols-1 lg:grid-cols-3 pt-20 lg:pt-4 shadow-md ">
      ...
      <div className="bg-version2-400  lg:pt-16 relative top-14 lg:top-[36%] py-14 px-5 md:px-6 lg:px-8 text-sm font-medium text-neutral-100 text-left lg:text-justify h-fit  leading-4 md:text-sm ">
        ...
        <p className="mb-1 ">
          ...
          Surabaya, M-Knows Consulting telah sukses melayani beragam perusahaan dengan kualitas
          kerja yang memuaskan, sesuai keahliannya dan pendekatan konsultasi yang didasarkan pada :
        </p>
        ...
        <p className="mb-4">
          ...
          berpengalaman dalam mengelola program public training & in house training, yang sering
          kali merupakan bagian dari konsultasi.
        </p>
        <p>
