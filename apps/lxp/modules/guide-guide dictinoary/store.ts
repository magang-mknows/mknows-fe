  ...
  default: [
    {
      ...
      title: 'Batch',
      description:
        'Batch merupakan angkatan dari program pelatihan yang sedang diikuti.',
      slug: 'batch',
    },
    {
      id: '2',
    ...
    },
    {
      ...
      title: 'Nilai',
      description:
        'Merupakan representasi hasil dari tes yang dilakukan yang berupa angka.',
      slug: 'nilai',
    },
    {
      id: '4',
...
export const filterOptionDictionary = selectorFamily({
  ...
  get:
    (query: string) =>
    ({ get }) =>
      get(GuideDictionaryState).filter((item) =>
        (item.slug as unknown as string).includes(query)
      ),
});
