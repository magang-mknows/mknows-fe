      ...
      <div className="px-6 md:px-8 lg:px-16 xl:px-40 py-14 w-full flex flex-col  min-h-screen">
        ...
        <section className=" w-full flex justify-center gap-y-5 lg:justify-end mt-10 flex-wrap lg:flex-nowrap gap-x-5 ">
          <div className="w-full lg:w-80 ">
            <button
              type="button"
              className="text-[#053D38]  border-2  border-[#053D38] bg-white  hover:bg-neutral-50 w-full   h-12 rounded-md shadow-sm font-bold transition-colors ease-out duration-300"
            >
              Riwayat Quiz
            </button>
          </div>
          <div className="w-full lg:w-80 ">
            <button className="bg-[#053D38] text-[#FFFF]  text-white hover:bg-primary-600    w-full   h-12 rounded-md shadow-sm font-bold  transition-colors ease-out duration-300">
              Coba Kembali (Sisa 2)
            </button>
          </div>
        </section>
