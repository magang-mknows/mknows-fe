...
const HistoryCard: FC = (): ReactElement => {
  return (
    <section className="bg-[#FFF] shadow-sm rounded-md px-5 py-4 w-full">
      ...
      <section className="lg:flex lg:gap-x-2 lg:items-stretch my-6">
        <div className="flex flex-col w-full  dark:border-none lg:w-28 py-9 mb-2 lg:mb-0  border-2 border-[#F5F5F5]  items-center justify-center rounded-md">
