...
export const HeroSection: FC = (): ReactElement => {
  return (
    <div className="flex flex-col  items-center pt-16 md:pt-20 lg:pt-24 relative overflow-hidden">
      ...
      <div className="px-2 relative z-40 md:px-20 lg:px-32 xl:px-[340px] mb-6 md:mb-8 lg:mb-10">
      ...
      <div className="px-8 relative z-40 md:px-12 lg:px-16 xl:px-[420px] text-center mb-6 md:mb-8 lg:mb-10">
